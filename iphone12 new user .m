...
newUserInput = [5, 7, 2, 3, 1, 25, 2815];  % Example input: [Screen_Time_Hours, Charging_Cycles_Per_Week, Bluetooth_Hours, Cellular_Data_Hours, GPS_Hours, Ambient_Temperature_Celsius, Battery_Capacity_mAh]
